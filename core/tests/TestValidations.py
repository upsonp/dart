...
class ValidationTest(TestCase):
    ...
    def test_validation_start_lt_end_id(self):
        ...
        ctd_event = eff.CTDEventFactory(sample_id=495100, end_sample_id=495000, actions=[
    ...
    def test_validation_sample_id_exists(self):
        ...
        ctd_event = eff.CTDEventFactory(sample_id=None, end_sample_id=495000, actions=[
            models.ActionType.deployed,
            models.ActionType.bottom,
            models.ActionType.recovered
        ])
    ...
    def test_validation_end_sample_id_exists(self):
        ...
        ctd_event = eff.CTDEventFactory(sample_id=495000, end_sample_id=None, actions=[
            models.ActionType.deployed,
            models.ActionType.bottom,
            models.ActionType.recovered
        ])
    ...
    def test_validation_start_and_end_sample_id_exists(self):
        ...
        ctd_event = eff.CTDEventFactory(sample_id=None, end_sample_id=None, actions=[
            models.ActionType.deployed,
            models.ActionType.bottom,
            models.ActionType.recovered
        ])
    ...
    def test_validation_ring_net_202(self):
        ...
        eff.RingnetInstrumentSensorFactory(event=ringnet_event_good, name="202um")
        ...
        ringnet_event_bad = eff.RingnetEventFactory(sample_id=295000, actions=[
                                                         models.ActionType.deployed,
                                                         models.ActionType.bottom,
                                                         models.ActionType.recovered
                                                     ])
        ...
        eff.RingnetInstrumentSensorFactory(event=ringnet_event_bad, name="202um")
    ...
    def test_validation_ring_net_76(self):
        ...
        ringnet_event_good = eff.RingnetEventFactory(sample_id=expected_end_id, actions=[
            models.ActionType.deployed,
            models.ActionType.bottom,
            models.ActionType.recovered
        ])
        eff.RingnetInstrumentSensorFactory(event=ringnet_event_good, name="76um")
        ...
        eff.RingnetInstrumentSensorFactory(event=ringnet_event_bad, name="76um")
